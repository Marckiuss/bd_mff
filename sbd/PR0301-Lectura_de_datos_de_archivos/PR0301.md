...
Región Sur (ventas_sur.xlsx): el equipo de ventas usa Excel. El archivo contiene múltiples pestañas (una por me

s).
Región  ste (ventas_este.json): eatos provenientes de una API moderna. La información del producto y del cliente está anidada dentro de diccionarios.
